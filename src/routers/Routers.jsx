  ...
  return (
    ...
    <Routes>
        ...
        <Route path='/user'>
            ...
            <Route path=':userid/jobs/:jobid' element={ <ProtectedRoutes Comp={ <Expandedjob/> } /> }/>
            <Route path=':userid/profile' element={<ProtectedRoutes Comp={<Profile_User typeOfUser="User" />} />} />
        </Route>
        ...
        <Route path='/admin'>
            ...
            <Route path=':adminid/profile' element={ <ProtectedRoutes Comp={ <Profile_Admin typeOfUser="Admin"/> } /> }/>
        </Route>
        {/* ---------------------------------------------------- */}
